	...
	event =
		add: (req, res, next) ->
			if req.me
				...
				start = moment.utc('2022'+month+req.query.date+' '+req.query.hour+':'+req.query.minute+':00', 'YYYY-MM-DD HH:mm:ss')
				...
				if req.query.end_hour? && req.query.end_minute?
					end = moment.utc('2022'+month+req.query.date+' '+req.query.end_hour+':'+req.query.end_minute+':00', 'YYYY-MM-DD HH:mm:ss')
		...
		get_pdf: (req, res, next) ->
			from = '2022'+"-06-"+req.query.from_date+" "
