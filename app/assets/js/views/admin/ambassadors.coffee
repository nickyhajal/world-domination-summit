      ...
      ap.api 'get admin/ambassadors', {}, (rsp) ->
        ...
        for atn in rsp.users
          ...
          html += '<tr data-speaker="'+atn.get('user_id')+'">
            ...
            <td>'+atn.get('email')+'</td>
            <td>
            <a href="/api/admin/ambassador_accept?id='+atn.get('user_id')+'" class="button ambassador-button">Accept</a>
            <a href="/api/admin/ambassador_reject?id='+atn.get('user_id')+'" class="button ambassador-button">Reject</a>
            </td>'
