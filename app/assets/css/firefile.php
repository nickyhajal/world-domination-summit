...
class FireFileBase {
    ...
    private function prepareCss($css) {
        ...
        $filters = array(
            ...
            "ConvertLevel3AtKeyframes"      => false,//array("RemoveSource" => true),
